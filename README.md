...
<br>**Manufacturer-Independent Drone Platform**.

Each document provides detailed explanations of the system design, architecture,
<br>and operational logic for individual services.
...
| Server               | S3 Guide    | Amazon S3, IAM Policy, Role, User, Server setup guide | [Docs](https://github.com/seyun4047/drone-platform-docs/blob/main/components/server/S3_GUIDE.md) |
