...
## 개요
드론 플랫폼 서버는 제조사에 독립적인 드론 플랫폼의 핵심 백엔드 서비스입니다.
이 서버는 플랫폼 전반에 걸쳐 드론 세션의 전체 수명 주기 관리, 인증, 텔레메트리 처리, 그리고 대규모 요청 처리를 담당합니다.
...
## DB 가이드
### MySQL DB 사용 가이드
> MySQL 사용 가이드를 알고 싶다면 여기를 확인하십시오: [DB GUIDE](https://github.com/seyun4047/drone-platform-docs/blob/main/components/server/DB_GUIDE.md)
---