...
이 서버는 드론 세션의 전체 수명 주기 관리, 인증, 텔레메트리 처리, 그리고 플랫폼 전반의 대용량 요청 처리를 담당합니다.
...
- **드론 인증 토큰 (Redis)**<br>
인증된 드론을 위한 접근 토큰을 발행하고 유효성을 검사합니다.
...
- **접근 제어 강제 적용**<br>
인증 및 승인된 사용자만이 대시보드 API에 접근할 수 있도록 하여 데이터 무결성과 개인 정보 보호를 보장합니다.
