해당문서는 gemini-2.5-flash-lite 로 번역되어 부자연스러운 부분이 있을 수 있으니,<br>정확한 내용을 여기서 확인해주세요.<br>원본보기: [ENGLISH GUIDE](https://github.com/seyun4047/drone-platform-docs/blob/main/components/server/server.md)
...
드론 세션의 전체 수명 주기, 인증, <br>텔레메트리 처리 및 플랫폼 전반의 대규모 요청 처리를 관리합니다.<br>
...
## DB 가이드
### MYSQL DB 사용 가이드
> MySQL 사용 가이드에 대해 알아보려면 여기를 확인하세요: [DB 가이드](https://github.com/seyun4047/drone-platform-docs/blob/main/components/server/DB_GUIDE.md)
---