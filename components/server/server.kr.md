해당문서는 gemini-2.5-flash-lite 로 번역되어 부자연스러운 부분이 있을 수 있으니, 정확한 내용을 여기서 확인해주세요..₩n원본보기: [ENGLISH GUIDE](https://github.com/seyun4047/drone-platform-docs/blob/main/components/server/server.md)
...
---
## 개요
Drone Platform Server는 제조사 독립 드론 플랫폼의 핵심 백엔드 서비스입니다.<br>

드론 세션의 전체 수명 주기 관리, 인증, <br>원격 측정 데이터 처리, 그리고 플랫폼 전반에 걸친 대량 요청 처리를 담당합니다.<br>
