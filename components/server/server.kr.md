...
이 서버는 드론 세션의 전체 수명 주기 관리, 인증, <br>텔레메트리 처리 및 플랫폼 전반에 걸친 대규모 요청 처리를 담당합니다.<br>
...
```
### 실제 데이터로 흐름 테스트
> 실제 드론 데이터로 테스트하고 싶다면 여기를 확인하세요: [드론 데이터 테스터](https://github.com/seyun4047/drone-platform-trans-tester)   
