...
그러나 이러한 시스템에는 명확한 한계가 있습니다. 주로 특정 드론 모델을 튜닝하거나 단일 유형의 맞춤형 드론을 운용하는 방식에 의존하여, 전문 인력과 독점 기술에 대한 강력한 의존성을 초래합니다.
...
누구라도 조작 가능한 드론이 있다면 즉시 배치하여 다음을 수행할 수 있습니다:
- 피해자 평가
- 위험 요소 식별
- 피해 규모 추정
