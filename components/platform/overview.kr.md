Here's the Korean translation of the provided text:
...
하나의 환경 내에서 다양한 드론을 관리할 수 있도록 설계되었으며,
**고성능 전문가용 드론과 상업적으로 이용 가능한 취미용 카메라 드론** 모두
...
맞춤형 드론, 상업용 드론, 소비자용 드론은 기본적인 제어 메커니즘은 유사하지만,
...
최근 많은 기관과 기업들이 AI 기술과 통합된 드론 시스템 구축을 시도해 왔습니다.
하지만 이러한 시스템에는 명확한 한계가 있습니다. 일반적으로 특정 드론 모델에 맞게 조정하거나 단일 유형의 맞춤 제작 드론을 운용하는 데 의존하며, 이는 전문 인력 및 독점 기술에 대한 강력한 의존성으로 이어집니다.
...
인명 구조 및 재난 대응 시나리오에서 전문 장비나 구조 팀이 현장에 도착하기 전에,
운용 가능한 모든 드론 — 누구든 운용할 수 있다면 — 은 즉시 배포되어 다음을 수행할 수 있습니다.
- 피해자 평가
- 위험 요소 식별
- 피해 추정

이 중요한 **골든 타임**을 확보함으로써, 시스템은 더 빠른 의사 결정과 고급 구조 자원의 보다 효과적인 배치를 가능하게 하여, 궁극적으로 더욱 정교하고 영향력 있는 드론 지원 비상 대응 시스템으로 이어집니다.
