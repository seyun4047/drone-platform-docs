...
---
## 작동 방식 (How It Works)
모니터링 서버는 독립적인(로컬) 서비스로 실행되며, <br>주 [드론 플랫폼 서버](https://github.com/seyun4047/drone-platform-server)에서 이미 실행 중인 Redis 및 MySQL 인스턴스에 연결됩니다.

이 시스템은 Redis ZSET 기반의 심박(하트비트) 모니터링 메커니즘을 사용하여 <br>심박 전송을 중단한 드론을 자동으로 감지하고 연결을 해제합니다.

---
## 모니터링 내용 (What It Monitors)
