원본보기: [ENGLISH GUIDE](https://github.com/seyun4047/drone-platform-docs/blob/main/components/monitoring-server/monitoring-server.md)
...
이 시스템은 Redis ZSET 기반의 하트비트 모니터링 메커니즘을 사용하여, 하트비트를 더 이상 보내지 않는 드론을 자동으로 감지하고 연결을 해제합니다.
